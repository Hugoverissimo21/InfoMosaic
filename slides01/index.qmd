...
To address the 'Not News' problem, I created a small dataset with several features to train and test a model for detecting non-news content.
...
After experimenting with various models and combinations of features, I discovered that a decision tree utilizing the following features and parameters provided the best fit for the data.
...
```{.python code-line-numbers="1-10|12-20|22-37|39-49|51-59|61-64|72-88|91"}
# FEATURES
# added "aliases" to all func in order to run all together
...
def filter_sentences_by_keywords(text, aliases):
    ...
    # filter sentences with any of the aliases
