...
Developed a web application using `Flask`, equipped with a variety of tools for topic (companies) analysis based on news articles. to merge all visualizations and data and all the process from the before projects.
