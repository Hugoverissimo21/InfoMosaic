...
Took inspiration from [The Higher Lower Game](http://www.higherlowergame.com) and [Noticioso](https://noticioso.pt).
...
- Develop an algorithm that efficiently selects news articles containing the topic the user is searching for, and converts the data into the input format for the web application.

- Implement the solution in the web application and optimize it for computational efficiency.
